...
Si ves un mensaje diciendo que el comando no fue encontrado, significa que aún no lo tienes instalado. Puedes encontrar más información en la página oficial de node:[ ](https://nodejs.org/es/docs/)[https://nodejs.org/es/docs/](https://nodejs.org/es/docs/)
...
![Herramientas del desarrollador](../.gitbook/assets/js1.jpg)
